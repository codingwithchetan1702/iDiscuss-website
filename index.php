    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img src="https://source.unsplash.com/2400x800/?programmers,fecabook" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<div class="col-md-4 my-2">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title"><a href="threads-list.php?catid='.$catid.'">'.$cat.'</a></h5>
                            <p class="card-text">'.substr($desc, 0, 50).' ...</p>
                            <a href="threads-list.php?catid='.$catid.'" class="btn btn-primary">View Threads</a>
                        </div>
                    </div>
                </div>';
            }
